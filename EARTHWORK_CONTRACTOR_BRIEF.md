...
**Property Size:** 9.5 acres (5 acres active pasture)

---

## Project Overview

Convert 5-acre pasture into silvopasture system using contour swales for water harvesting, with integrated irrigation distribution and access road. Work includes rehabilitation of failing irrigation control structures at water entry point.
...
### 1. Blackberry Removal (FIRST)
- **Location:** Lower pasture area (paddocks 5-7)
- **Requirement:** Must be cleared before earthwork can proceed
- **Method:** TBD (mechanical removal, cut/treat, etc.)
- **Photos:** #35 (extent)
...
- **Wetland note:** NW wetland is uphill from swales - no buffer needed for swale overflow, but avoid disturbance during earthwork
- **Photos:** #06 (north boundary), #08 (south boundary), #32-34 (pasture conditions)
...
- **Photos:** #08 (south boundary), #41 (current access condition)
...
- **Current condition:** 
  ...
  - Age: Unknown (older than anyone remembers)
  - Water loss to unintended areas before reaching pastures
- **Scope:** 
  - Remove existing structures
  - Install new water control structures with functional gates
  - Connect to existing inlet/outlet
  - Ensure watertight, controllable flow
- **Photos:** 
  - Context: #14 (wide shot of area)
  - Box 1: #15-20 (location, access, damage, interior, inlet, outlet)
  - Box 2: #21-26 (location, access, damage, interior, inlet, outlet)
...
IRRIGATION DISTRIBUTION DIAGRAM (water flows S→N, swales numbered in flow direction):
    ...
    (NW corner,                         ▲       │ Paddocks 5-6
     ...
     catchment)    ║               SWALE 4 ──┘ ─┐
                   ...
                   ║               SWALE 2 ──┘ ─┐
                   ║                    ▲       │ Paddocks 1-2
                   ╠════▶ GATE 1 ══▶ SWALE 1 / S ACCESS ROAD
                   ║                    ▲
                   ▲                    │
               8" PIPE           IRRIGATION DITCH
                   ▲
               WATER SOURCE
                            SOUTH (irrigation source)
```
...
- **Equipment access:** Via existing access from south (near barns)
- **Wetland:** NW corner (uphill from swales) - avoid disturbance, but no overflow buffer needed
- **Irrigation schedule:** Flood irrigation every 2 weeks (2.5 days) - coordinate timing
- **Soil conditions:** TBD - may affect timing
- **Water on site:** Available at both barns
- **Photos:** #01 (overview), #37-40 (barns, water connections), #10-12 (wetland)

---

## Questions for Contractor

1. Can you do control box replacement, or should that be separate concrete contractor?
2. What swale profile do you recommend for this application (width, depth, berm height)?
3. Timeline estimate - when could work begin? How long for completion?
4. Any concerns about wetland buffer or site access?
5. Preferred materials for control structures (prefab vs. poured)?
...
|----------|----------|-------|
| Blackberry removal | $1,500 | May be included or separate |
| Earthwork (swales + road) | $12,000 - $15,000 | Based on expanded scope |
| Control box replacement | $5,000 - $15,000 | Depends on condition/approach |
| Irrigation distribution | ~$800 | Materials - owner can supply |
| **Total earthwork/infrastructure** | $19,000 - $32,000 | Range depending on conditions |

*Seeking itemized quote based on actual site assessment.*
